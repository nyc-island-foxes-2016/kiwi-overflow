...
rails_q = Question.create(title: "How do I build a Rails app?", content: "Wondering how to do this", user: nicola)
sinatra_q =Question.create(title: "How do I build a Sinatra app?", content: "Wondering how to do this", user: luis)
mvc_q = Question.create(title: "What is MVC?", content: "design patterns, yo", user: zach)
css_q = Question.create(title: "What are the best CSS styles?", content: "Should I style things?", user: jeff)
...
Answer.create(content:"Use the sinatra gem and make restful routes.", user: luis, question: sinatra_q)
Answer.create(content:"Model, view, controller, duh.", user: nicola, question: mvc_q)
